<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link " href="#tab4" data-toggle="tab">Dosya Oluştur</a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div id="tab4" class="tab-pane">
        <button class="btn btn-success mb-2" id="asd" onclick="showFileModal()" type="button">Dosya oluştur</button>
    </div>
